...
public class PartQueryController {
    ...
    @Operation(summary = "查询批次层级", description = "根据板件码查询对应批次及其完整层级结构，板件节点包含 rotate、processCode，预包装订单节点包含 type、fdd8 等字段")
    @ApiResponses({
    ...
    @Operation(summary = "查询包装层级", description = "根据板件码查询对应预包装订单及其完整层级结构，板件节点包含 rotate、processCode，预包装订单节点包含 type、fdd8 等字段")
    @ApiResponses({
    ...
    @Operation(summary = "查询板件详细信息", description = "根据板件码查询板件自身与上层层级实体信息，返回 rotate、processCode 以及预包装订单 type、fdd8 等字段")
    @ApiResponses({
