...
(
    ...
    unit                varchar(128)                       null comment '单元',
    is_deleted          tinyint  default 0                 null comment '删除标识（0=正常，1=已删除）',
    created_by          varchar(100)                       null comment '创建人',
    created_time        datetime default CURRENT_TIMESTAMP null comment '创建时间',
    updated_by          varchar(100)                       null comment '更新人',
...
(
    ...
    box_type2    varchar(64)                        null comment '纸箱类型（二级）',
    is_deleted   tinyint  default 0                 null comment '删除标识（0=正常，1=已删除）',
    created_by   varchar(100)                       null comment '创建人',
    created_time datetime default CURRENT_TIMESTAMP null comment '创建时间',
    updated_by   varchar(100)                       null comment '更新人',
...
(
    ...
    item_length   varchar(64)                        null comment '板件长',
    item_width    varchar(64)                        null comment '板件宽',
    item_depth    varchar(64)                        null comment '板件高',
    x_axis        varchar(64)                        null comment 'X轴坐标',
    y_axis        varchar(64)                        null comment 'Y轴坐标',
    z_axis        varchar(64)                        null comment 'Z轴坐标',
    ...
    workmanship   varchar(128)                       null comment '工艺名称',
...
(
    ...
    is_project           tinyint                            null comment '是否项目',
    customer_name        varchar(255)                       null comment '客户名称',
    fnumber              varchar(128)                       null comment 'FNUMBER',
    dob                  varchar(64)                        null comment 'DOB',
    detailed_address     varchar(512)                       null comment '详细地址',
    is_deleted           tinyint  default 0                 null comment '删除标识（0=正常，1=已删除）',
    created_by           varchar(100)                       null comment '创建人',
    created_time         datetime default CURRENT_TIMESTAMP null comment '创建时间',
    updated_by           varchar(100)                       null comment '更新人',
