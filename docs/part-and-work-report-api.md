...
| nestingTime | string | 开料/排样时间 |
| simpleBatchNum | string | 简易批次号 |
| ymba014 | string | 线路/区域信息 |
| ymba016 | string | 属性标识 |
...
| deliveryTime | string | 交付日期 |
| nestingTime | string | 开料/排样时间 |
| ymba014 | string | 线路/区域信息 |
| ymba015 | string | 工位/区域信息 |
| ymba016 | string | 属性标识 |
| part0 | string | 部件字段 |
| condition0 | string | 条件字段 |
| partTime0 | string | 部件时间字段 |
| zuz | integer | 组/套标记 |
...
| batchId | long | 批次ID |
| batchNum | string | 批次号（冗余） |
| workId | string | 工单号（冗余） |
| orderNum | string | 订单号 |
| consignor | string | 发货人 |
| contractNo | string | 合同编号 |
| workNum | string | 工单号（业务字段） |
| receiver | string | 收货人 |
| phone | string | 联系电话 |
| shipBatch | string | 出货批次号 |
| installAddress | string | 安装地址 |
| customer | string | 终端客户名 |
| receiveRegion | string | 收货地区 |
| space | string | 产品所属空间 |
| packType | string | 包件类型 |
| productType | string | 产品类型 |
| prepackageInfoSize | integer | 预包装总包数 |
